...
//             <p className="mt-4 text-base text-slate-300 max-w-xl leading-relaxed font-normal  text-justify">
...
//               <p className="text-slate-600 mt-3 text-sm leading-relaxed  text-justify">{item.text}</p>
//             </div>
//           ))}
//         </div>
//       </section>
...
//               </div> */}
//               <div className="w-48 h-48 overflow-hidden rounded-lg border-4 border-amber-500 shadow-lg mb-5">
//                 <img
//                   src={member.image}
//                   alt={member.name}
...
//             </h2>
//             <p className="text-slate-600 mt-4 text-sm leading-relaxed  text-justify">
